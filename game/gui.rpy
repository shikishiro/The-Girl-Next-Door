...
define gui.hover_color = '#3fcdff'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#ffbde9'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#d1eaff'
...
define gui.text_font = "gui/fonts/Acme-Regular.ttf"

## The font used for character names.
define gui.name_text_font = "gui/fonts/KGFallForYou.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "gui/fonts/FredokaOne-Regular.ttf"
...
define gui.quick_button_text_selected_color = "#3fcdff"
...
define gui.nvl_borders = Borders(0, 15, 0, 20)
